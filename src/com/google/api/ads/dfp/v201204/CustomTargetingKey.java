...
public class CustomTargetingKey  implements java.io.Serializable {
     ...
     * for a line item. */
    private com.google.api.ads.dfp.v201204.CustomTargetingKeyType type;
    ...
    public CustomTargetingKey(
           ...
           com.google.api.ads.dfp.v201204.CustomTargetingKeyType type) {
           this.id = id;
           this.name = name;
     ...
     * for a line item.
     */
    public com.google.api.ads.dfp.v201204.CustomTargetingKeyType getType() {
        return type;
    }
     ...
     * for a line item.
     */
    public void setType(com.google.api.ads.dfp.v201204.CustomTargetingKeyType type) {
        this.type = type;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201204", "CustomTargetingKey"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201204", "CustomTargetingKey.Type"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
