...
public class LineItemCreativeAssociationServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.v201002.LineItemCreativeAssociationService {
    ...
    public com.google.api.ads.dfp.v201002.LineItemCreativeAssociationServiceInterface getLineItemCreativeAssociationServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.v201002.LineItemCreativeAssociationServiceInterface getLineItemCreativeAssociationServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.v201002.LineItemCreativeAssociationServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201002.LineItemCreativeAssociationServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.v201002.LineItemCreativeAssociationServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.v201002.LineItemCreativeAssociationServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201002.LineItemCreativeAssociationServiceSoapBindingStub(new java.net.URL(LineItemCreativeAssociationServiceInterfacePort_address), this);
                _stub.setPortName(getLineItemCreativeAssociationServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201002", "LineItemCreativeAssociationService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201002", "LineItemCreativeAssociationServiceInterfacePort"));
        }
