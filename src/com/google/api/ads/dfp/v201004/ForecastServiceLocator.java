...
public class ForecastServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.v201004.ForecastService {
    ...
    private java.lang.String ForecastServiceInterfacePort_address = "https://sandbox.google.com/apis/ads/publisher/v201004/ForecastService";
    ...
    public com.google.api.ads.dfp.v201004.ForecastServiceInterface getForecastServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.v201004.ForecastServiceInterface getForecastServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.v201004.ForecastServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201004.ForecastServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.v201004.ForecastServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.v201004.ForecastServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201004.ForecastServiceSoapBindingStub(new java.net.URL(ForecastServiceInterfacePort_address), this);
                _stub.setPortName(getForecastServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201004", "ForecastService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201004", "ForecastServiceInterfacePort"));
        }
