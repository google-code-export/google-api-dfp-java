...
public class ThirdPartySlot  implements java.io.Serializable {
     ...
     * is read-only. */
    private com.google.api.ads.dfp.v201208.ThirdPartySlotStatus status;
    ...
    public ThirdPartySlot(
           ...
           com.google.api.ads.dfp.v201208.ThirdPartySlotStatus status) {
           this.id = id;
     ...
     * is read-only.
     */
    public com.google.api.ads.dfp.v201208.ThirdPartySlotStatus getStatus() {
        return status;
    }
     ...
     * is read-only.
     */
    public void setStatus(com.google.api.ads.dfp.v201208.ThirdPartySlotStatus status) {
        this.status = status;
    }
