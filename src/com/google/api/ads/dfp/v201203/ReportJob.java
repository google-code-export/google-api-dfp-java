...
public class ReportJob  implements java.io.Serializable {
    ...
    private com.google.api.ads.dfp.v201203.ReportQuery reportQuery;

    /* The status of the {@code ReportJob}. This attribute is read-only
     * and is
     *                 assigned by Google. */
    private com.google.api.ads.dfp.v201203.ReportJobStatus reportJobStatus;
    ...
    public ReportJob(
           java.lang.Long id,
           com.google.api.ads.dfp.v201203.ReportQuery reportQuery,
           com.google.api.ads.dfp.v201203.ReportJobStatus reportJobStatus) {
           this.id = id;
     ...
     */
    public com.google.api.ads.dfp.v201203.ReportQuery getReportQuery() {
        return reportQuery;
    }
     ...
     */
    public void setReportQuery(com.google.api.ads.dfp.v201203.ReportQuery reportQuery) {
        this.reportQuery = reportQuery;
    }
     ...
     *                 assigned by Google.
     */
    public com.google.api.ads.dfp.v201203.ReportJobStatus getReportJobStatus() {
     ...
     *                 assigned by Google.
     */
    public void setReportJobStatus(com.google.api.ads.dfp.v201203.ReportJobStatus reportJobStatus) {
        this.reportJobStatus = reportJobStatus;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201203", "ReportJob"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201203", "reportQuery"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201203", "ReportQuery"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("reportJobStatus");
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201203", "reportJobStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201203", "ReportJobStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
