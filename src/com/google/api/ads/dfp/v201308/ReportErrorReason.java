...
public class ReportErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _INVALID_TIME_ZONE_FOR_FEATURE_NOT_ENABLED = "INVALID_TIME_ZONE_FOR_FEATURE_NOT_ENABLED";
    public static final java.lang.String _INVALID_TIME_ZONE_FOR_ID = "INVALID_TIME_ZONE_FOR_ID";
    public static final java.lang.String _UNSUPPORTED_TIME_ZONE = "UNSUPPORTED_TIME_ZONE";
    ...
    public static final ReportErrorReason INVALID_TIME_ZONE_FOR_FEATURE_NOT_ENABLED = new ReportErrorReason(_INVALID_TIME_ZONE_FOR_FEATURE_NOT_ENABLED);
    public static final ReportErrorReason INVALID_TIME_ZONE_FOR_ID = new ReportErrorReason(_INVALID_TIME_ZONE_FOR_ID);
    public static final ReportErrorReason UNSUPPORTED_TIME_ZONE = new ReportErrorReason(_UNSUPPORTED_TIME_ZONE);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201308", "ReportError.Reason"));
    }
    /**
