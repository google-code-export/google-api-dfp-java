...
public class ReconciliationOrderReport  implements java.io.Serializable {
     ...
     *                 This value is read-only and is assigned by Google
     * when the order report is created. */
    private com.google.api.ads.dfp.v201308.ReconciliationOrderReportStatus status;

    /* The time when this order report is submitted.
     *                 This value is read-only and is assigned by Google
     * when the order report is created. */
    private com.google.api.ads.dfp.v201308.DateTime submissionDateTime;
    ...
    public ReconciliationOrderReport(
           ...
           com.google.api.ads.dfp.v201308.ReconciliationOrderReportStatus status,
           com.google.api.ads.dfp.v201308.DateTime submissionDateTime,
     ...
     * when the order report is created.
     */
    public com.google.api.ads.dfp.v201308.ReconciliationOrderReportStatus getStatus() {
        return status;
    }
     ...
     * when the order report is created.
     */
    public void setStatus(com.google.api.ads.dfp.v201308.ReconciliationOrderReportStatus status) {
        this.status = status;
    }
     ...
     * when the order report is created.
     */
    public com.google.api.ads.dfp.v201308.DateTime getSubmissionDateTime() {
     ...
     * when the order report is created.
     */
    public void setSubmissionDateTime(com.google.api.ads.dfp.v201308.DateTime submissionDateTime) {
        this.submissionDateTime = submissionDateTime;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201308", "ReconciliationOrderReport"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201308", "ReconciliationOrderReportStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("submissionDateTime");
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201308", "submissionDateTime"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201308", "submitterId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
