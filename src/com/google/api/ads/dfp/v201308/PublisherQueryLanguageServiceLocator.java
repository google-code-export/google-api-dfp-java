...
public class PublisherQueryLanguageServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.v201308.PublisherQueryLanguageService {
    ...
    private java.lang.String PublisherQueryLanguageServiceInterfacePort_address = "https://www.google.com/apis/ads/publisher/v201308/PublisherQueryLanguageService";
    ...
    public com.google.api.ads.dfp.v201308.PublisherQueryLanguageServiceInterface getPublisherQueryLanguageServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.v201308.PublisherQueryLanguageServiceInterface getPublisherQueryLanguageServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.v201308.PublisherQueryLanguageServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201308.PublisherQueryLanguageServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.v201308.PublisherQueryLanguageServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.v201308.PublisherQueryLanguageServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201308.PublisherQueryLanguageServiceSoapBindingStub(new java.net.URL(PublisherQueryLanguageServiceInterfacePort_address), this);
                _stub.setPortName(getPublisherQueryLanguageServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201308", "PublisherQueryLanguageService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201308", "PublisherQueryLanguageServiceInterfacePort"));
        }
