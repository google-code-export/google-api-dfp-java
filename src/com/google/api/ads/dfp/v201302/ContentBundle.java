...
public class ContentBundle  implements java.io.Serializable {
    ...
    public ContentBundle(
           ...
           com.google.api.ads.dfp.v201302.ContentBundleStatus status) {
           this.id = id;
           this.name = name;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201302", "ContentBundle"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201302", "ContentBundleStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
