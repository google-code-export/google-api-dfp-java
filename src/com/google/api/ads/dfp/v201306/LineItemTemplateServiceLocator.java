...
public class LineItemTemplateServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.v201306.LineItemTemplateService {
    ...
    public com.google.api.ads.dfp.v201306.LineItemTemplateServiceInterface getLineItemTemplateServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.v201306.LineItemTemplateServiceInterface getLineItemTemplateServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.v201306.LineItemTemplateServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201306.LineItemTemplateServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.v201306.LineItemTemplateServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.v201306.LineItemTemplateServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201306.LineItemTemplateServiceSoapBindingStub(new java.net.URL(LineItemTemplateServiceInterfacePort_address), this);
                _stub.setPortName(getLineItemTemplateServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201306", "LineItemTemplateService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201306", "LineItemTemplateServiceInterfacePort"));
        }
