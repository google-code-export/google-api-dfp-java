...
public class AdRuleServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.v201306.AdRuleService {
    ...
    public com.google.api.ads.dfp.v201306.AdRuleServiceInterface getAdRuleServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.v201306.AdRuleServiceInterface getAdRuleServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.v201306.AdRuleServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201306.AdRuleServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.v201306.AdRuleServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.v201306.AdRuleServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201306.AdRuleServiceSoapBindingStub(new java.net.URL(AdRuleServiceInterfacePort_address), this);
                _stub.setPortName(getAdRuleServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201306", "AdRuleService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201306", "AdRuleServiceInterfacePort"));
        }
