...
public class RateCard  implements java.io.Serializable {
    ...
    private com.google.api.ads.dfp.v201306.RateCardStatus status;
    ...
    public RateCard(
           ...
           com.google.api.ads.dfp.v201306.RateCardStatus status,
           long[] appliedTeamIds) {
           this.id = id;
           this.name = name;
           this.status = status;
     ...
     *                 created in the {@link RateCardStatus#INACTIVE} state.
     */
    public com.google.api.ads.dfp.v201306.RateCardStatus getStatus() {
        return status;
    }
     ...
     *                 created in the {@link RateCardStatus#INACTIVE} state.
     */
    public void setStatus(com.google.api.ads.dfp.v201306.RateCardStatus status) {
        this.status = status;
    }
