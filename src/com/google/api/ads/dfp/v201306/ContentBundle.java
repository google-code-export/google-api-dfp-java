...
public class ContentBundle  implements java.io.Serializable {
    ...
    private com.google.api.ads.dfp.v201306.ContentBundleStatus status;
    ...
    public ContentBundle(
           ...
           com.google.api.ads.dfp.v201306.ContentBundleStatus status) {
           this.id = id;
           this.name = name;
     ...
     *                 defaults to {@link ContentBundleStatus#INACTIVE}.
     */
    public com.google.api.ads.dfp.v201306.ContentBundleStatus getStatus() {
        return status;
    }
     ...
     *                 defaults to {@link ContentBundleStatus#INACTIVE}.
     */
    public void setStatus(com.google.api.ads.dfp.v201306.ContentBundleStatus status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201306", "ContentBundle"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201306", "ContentBundleStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
