...
public class UserTeamAssociationServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.v201306.UserTeamAssociationService {
    ...
    public com.google.api.ads.dfp.v201306.UserTeamAssociationServiceInterface getUserTeamAssociationServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.v201306.UserTeamAssociationServiceInterface getUserTeamAssociationServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.v201306.UserTeamAssociationServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201306.UserTeamAssociationServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.v201306.UserTeamAssociationServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.v201306.UserTeamAssociationServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201306.UserTeamAssociationServiceSoapBindingStub(new java.net.URL(UserTeamAssociationServiceInterfacePort_address), this);
                _stub.setPortName(getUserTeamAssociationServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201306", "UserTeamAssociationService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201306", "UserTeamAssociationServiceInterfacePort"));
        }
