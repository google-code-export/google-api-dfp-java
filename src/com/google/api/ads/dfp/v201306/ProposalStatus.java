...
public class ProposalStatus implements java.io.Serializable {
    ...
    public static final ProposalStatus PENDING_APPROVAL = new ProposalStatus(_PENDING_APPROVAL);
    public static final ProposalStatus APPROVED = new ProposalStatus(_APPROVED);
    public static final ProposalStatus REJECTED = new ProposalStatus(_REJECTED);
    public static final ProposalStatus UNKNOWN = new ProposalStatus(_UNKNOWN);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201306", "ProposalStatus"));
    }
    /**
