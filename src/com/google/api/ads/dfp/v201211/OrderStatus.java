...
public class OrderStatus implements java.io.Serializable {
    ...
    public static final OrderStatus DISAPPROVED = new OrderStatus(_DISAPPROVED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201211", "OrderStatus"));
    }
    /**
