...
public class LineItemTemplateServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.v201311.LineItemTemplateService {
    ...
    public com.google.api.ads.dfp.v201311.LineItemTemplateServiceInterface getLineItemTemplateServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.v201311.LineItemTemplateServiceInterface getLineItemTemplateServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.v201311.LineItemTemplateServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201311.LineItemTemplateServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.v201311.LineItemTemplateServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.v201311.LineItemTemplateServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201311.LineItemTemplateServiceSoapBindingStub(new java.net.URL(LineItemTemplateServiceInterfacePort_address), this);
                _stub.setPortName(getLineItemTemplateServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
