 ...
 */
public class SubmitOrdersForApproval  extends com.google.api.ads.dfp.v201311.OrderAction  implements java.io.Serializable {
    /* Indicates whether the inventory check should be skipped when
     * performing this action.
     *                     The default value is false. */
    private java.lang.Boolean skipInventoryCheck;

    public SubmitOrdersForApproval() {
    }
    ...
    /**
     * Sets the skipInventoryCheck value for this SubmitOrdersForApproval.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SubmitOrdersForApproval)) return false;
        SubmitOrdersForApproval other = (SubmitOrdersForApproval) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SubmitOrdersForApproval.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201311", "SubmitOrdersForApproval"));
