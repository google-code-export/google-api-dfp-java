...
public class LabelServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.v201311.LabelService {
    ...
    public com.google.api.ads.dfp.v201311.LabelServiceInterface getLabelServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.v201311.LabelServiceInterface getLabelServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.v201311.LabelServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201311.LabelServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.v201311.LabelServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.v201311.LabelServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201311.LabelServiceSoapBindingStub(new java.net.URL(LabelServiceInterfacePort_address), this);
                _stub.setPortName(getLabelServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201311", "LabelService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201311", "LabelServiceInterfacePort"));
        }
