...
public class WorkflowRequestServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.v201311.WorkflowRequestService {
    ...
    private java.lang.String WorkflowRequestServiceInterfacePort_address = "https://www.google.com/apis/ads/publisher/v201311/WorkflowRequestService";
    ...
    public com.google.api.ads.dfp.v201311.WorkflowRequestServiceInterface getWorkflowRequestServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.v201311.WorkflowRequestServiceInterface getWorkflowRequestServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.v201311.WorkflowRequestServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201311.WorkflowRequestServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.v201311.WorkflowRequestServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.v201311.WorkflowRequestServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201311.WorkflowRequestServiceSoapBindingStub(new java.net.URL(WorkflowRequestServiceInterfacePort_address), this);
                _stub.setPortName(getWorkflowRequestServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201311", "WorkflowRequestService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201311", "WorkflowRequestServiceInterfacePort"));
        }
