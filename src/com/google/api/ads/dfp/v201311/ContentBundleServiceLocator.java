...
public class ContentBundleServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.v201311.ContentBundleService {
    ...
    public com.google.api.ads.dfp.v201311.ContentBundleServiceInterface getContentBundleServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.v201311.ContentBundleServiceInterface getContentBundleServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.v201311.ContentBundleServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201311.ContentBundleServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.v201311.ContentBundleServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.v201311.ContentBundleServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201311.ContentBundleServiceSoapBindingStub(new java.net.URL(ContentBundleServiceInterfacePort_address), this);
                _stub.setPortName(getContentBundleServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201311", "ContentBundleService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201311", "ContentBundleServiceInterfacePort"));
        }
