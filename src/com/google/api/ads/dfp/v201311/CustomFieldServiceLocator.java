...
public class CustomFieldServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.v201311.CustomFieldService {
    ...
    public com.google.api.ads.dfp.v201311.CustomFieldServiceInterface getCustomFieldServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.v201311.CustomFieldServiceInterface getCustomFieldServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.v201311.CustomFieldServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201311.CustomFieldServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.v201311.CustomFieldServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.v201311.CustomFieldServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201311.CustomFieldServiceSoapBindingStub(new java.net.URL(CustomFieldServiceInterfacePort_address), this);
                _stub.setPortName(getCustomFieldServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
