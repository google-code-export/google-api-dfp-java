 ...
 */
public class AssetCreativeTemplateVariable  extends com.google.api.ads.dfp.v201311.CreativeTemplateVariable  implements java.io.Serializable {
    /* A set of supported mime types. This set can be empty or null
     * if there's no
     *                     constraint, meaning files of any mime types are
     * allowed. */
    private com.google.api.ads.dfp.v201311.AssetCreativeTemplateVariableMimeType[] mimeTypes;
    ...
    public AssetCreativeTemplateVariable(
           ...
           com.google.api.ads.dfp.v201311.AssetCreativeTemplateVariableMimeType[] mimeTypes) {
        super(
            label,
            uniqueName,
            description,
     ...
     * allowed.
     */
    public com.google.api.ads.dfp.v201311.AssetCreativeTemplateVariableMimeType[] getMimeTypes() {
        return mimeTypes;
    }
     ...
     * allowed.
     */
    public void setMimeTypes(com.google.api.ads.dfp.v201311.AssetCreativeTemplateVariableMimeType[] mimeTypes) {
        this.mimeTypes = mimeTypes;
    }

    public com.google.api.ads.dfp.v201311.AssetCreativeTemplateVariableMimeType getMimeTypes(int i) {
        return this.mimeTypes[i];
    }

    public void setMimeTypes(int i, com.google.api.ads.dfp.v201311.AssetCreativeTemplateVariableMimeType _value) {
