...
public class InventoryServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.v201004.InventoryService {
    ...
    private java.lang.String InventoryServiceInterfacePort_address = "https://sandbox.google.com/apis/ads/publisher/v201004/InventoryService";
    ...
    public com.google.api.ads.dfp.v201004.InventoryServiceInterface getInventoryServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.v201004.InventoryServiceInterface getInventoryServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.v201004.InventoryServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201004.InventoryServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.v201004.InventoryServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.v201004.InventoryServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201004.InventoryServiceSoapBindingStub(new java.net.URL(InventoryServiceInterfacePort_address), this);
                _stub.setPortName(getInventoryServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201004", "InventoryService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201004", "InventoryServiceInterfacePort"));
        }
