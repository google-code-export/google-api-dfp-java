...
import com.google.api.ads.dfp.v201002.DeliveryRateType;
...
public class UpdateLineItemsExample {
  public static void main(String[] args) {
    try {
      ...
      // Create a filter to get line items with even delivery rates.
      Filter filter = new Filter("WHERE deliveryRateType = 'EVENLY'"
          + " and orderId = " + orderId + " LIMIT 500");
