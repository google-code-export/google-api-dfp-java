...
public class LineItemCreativeAssociationErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _STARTDATE_AFTER_LINEITEM_ENDDATE = "STARTDATE_AFTER_LINEITEM_ENDDATE";
    public static final java.lang.String _ENDDATE_BEFORE_LINEITEM_STARTDATE = "ENDDATE_BEFORE_LINEITEM_STARTDATE";
    public static final java.lang.String _ENDDATE_AFTER_LINEITEM_ENDDATE = "ENDDATE_AFTER_LINEITEM_ENDDATE";
    public static final java.lang.String _STARTDATE_AFTER_ENDDATE = "STARTDATE_AFTER_ENDDATE";
    public static final java.lang.String _ENDDATE_BEFORE_STARTDATE = "ENDDATE_BEFORE_STARTDATE";
    ...
    public static final LineItemCreativeAssociationErrorReason STARTDATE_AFTER_LINEITEM_ENDDATE = new LineItemCreativeAssociationErrorReason(_STARTDATE_AFTER_LINEITEM_ENDDATE);
    public static final LineItemCreativeAssociationErrorReason ENDDATE_BEFORE_LINEITEM_STARTDATE = new LineItemCreativeAssociationErrorReason(_ENDDATE_BEFORE_LINEITEM_STARTDATE);
    ...
    public static final LineItemCreativeAssociationErrorReason STARTDATE_AFTER_ENDDATE = new LineItemCreativeAssociationErrorReason(_STARTDATE_AFTER_ENDDATE);
    public static final LineItemCreativeAssociationErrorReason ENDDATE_BEFORE_STARTDATE = new LineItemCreativeAssociationErrorReason(_ENDDATE_BEFORE_STARTDATE);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201002", "LineItemCreativeAssociationError.Reason"));
    }
    /**
