...
import com.google.api.ads.dfp.v201101.ExportFormat;
...
public class RunAndGetReportCsvExample {
  public static void main(String[] args) throws Exception {
    ...
    reportQuery.setStartDateTime(DateTimeUtils.fromString("2011-05-01T00:00:00"));
    ...
    if (useSynchronous) {
      ...
      try {
        ...
        if (reportUtils.waitForReportReady()) {
          ...
          String csvString = reportUtils.getReport(ExportFormat.CSV);
