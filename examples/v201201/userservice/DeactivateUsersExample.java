  ...
  public static void main(String[] args) {
    try {
      ...
      UserServiceInterface userService =
          user.getService(DfpService.V201201.USER_SERVICE);
