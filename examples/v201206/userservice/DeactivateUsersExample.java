  ...
  public static void main(String[] args) {
    try {
      ...
      UserServiceInterface userService =
          user.getService(DfpService.V201206.USER_SERVICE);
