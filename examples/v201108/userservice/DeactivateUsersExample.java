  ...
  public static void main(String[] args) {
    try {
      ...
      UserServiceInterface userService =
          user.getService(DfpService.V201108.USER_SERVICE);
