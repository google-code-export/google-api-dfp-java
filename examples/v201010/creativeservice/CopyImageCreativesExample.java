...
package v201010.creativeservice;
...
import com.google.api.ads.dfp.v201010.Creative;
import com.google.api.ads.dfp.v201010.CreativePage;
import com.google.api.ads.dfp.v201010.CreativeServiceInterface;
import com.google.api.ads.dfp.v201010.ImageCreative;
  ...
  public static void main(String[] args) {
    try {
      ...
      CreativeServiceInterface creativeService =
          user.getService(DfpService.V201010.CREATIVE_SERVICE);
      ...
      StatementBuilder statementBuilder =
          new StatementBuilder("WHERE id IN ( " + StringUtils.join(imageCreativeIds, ',')
              + ") and creativeType = :creativeType LIMIT 500").putParam("creativeType",
