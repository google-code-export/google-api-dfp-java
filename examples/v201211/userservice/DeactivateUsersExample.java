  ...
  public static void main(String[] args) {
    try {
      ...
      UserServiceInterface userService =
          user.getService(DfpService.V201211.USER_SERVICE);
