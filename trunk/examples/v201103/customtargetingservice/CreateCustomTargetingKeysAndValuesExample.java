...
package v201103.customtargetingservice;

import com.google.api.ads.dfp.lib.DfpService;
import com.google.api.ads.dfp.lib.DfpServiceLogger;
import com.google.api.ads.dfp.lib.DfpUser;
import com.google.api.ads.dfp.v201103.CustomTargetingKey;
import com.google.api.ads.dfp.v201103.CustomTargetingKeyType;
import com.google.api.ads.dfp.v201103.CustomTargetingServiceInterface;
import com.google.api.ads.dfp.v201103.CustomTargetingValue;
import com.google.api.ads.dfp.v201103.CustomTargetingValueMatchType;
  ...
  public static void main(String[] args) {
    try {
      ...
      CustomTargetingServiceInterface customTargetingService =
          user.getService(DfpService.V201103.CUSTOM_TARGETING_SERVICE);
      ...
      CustomTargetingKey[] keys = customTargetingService.createCustomTargetingKeys(
          new CustomTargetingKey[] {genderKey, carModelKey});
      ...
      carModelHondaCivicValue.setCustomTargetingKeyId(keys[1].getId());
      ...
      CustomTargetingValue[] returnValues = customTargetingService.createCustomTargetingValues(
          new CustomTargetingValue[] {genderMaleValue, genderFemaleValue, carModelHondaCivicValue});
