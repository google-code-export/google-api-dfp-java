...
import com.google.api.ads.dfp.v201201.DeactivateLabels;
import com.google.api.ads.dfp.v201201.Label;
import com.google.api.ads.dfp.v201201.LabelPage;
...
public class DeactivateLabelsExample {
  public static void main(String[] args) {
    try {
      ...
      Statement filterStatement = new StatementBuilder("").putValue("isActive", true).toStatement();
