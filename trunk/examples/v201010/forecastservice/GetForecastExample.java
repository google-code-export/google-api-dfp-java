...
package v201010.forecastservice;
...
import com.google.api.ads.dfp.v201010.Forecast;
import com.google.api.ads.dfp.v201010.ForecastServiceInterface;
...
public class GetForecastExample {
  public static void main(String[] args) throws Exception{
    ...
    ForecastServiceInterface forecastService =
        user.getService(DfpService.V201010.FORECAST_SERVICE);
    ...
    lineItem.setTargeting(new Targeting(null, inventoryTargeting));
