...
public class CustomTargetingServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.v201101.CustomTargetingService {
    ...
    private java.lang.String CustomTargetingServiceInterfacePort_address = "https://www.google.com/apis/ads/publisher/v201101/CustomTargetingService";
    ...
    public com.google.api.ads.dfp.v201101.CustomTargetingServiceInterface getCustomTargetingServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.v201101.CustomTargetingServiceInterface getCustomTargetingServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.v201101.CustomTargetingServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201101.CustomTargetingServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.v201101.CustomTargetingServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.v201101.CustomTargetingServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201101.CustomTargetingServiceSoapBindingStub(new java.net.URL(CustomTargetingServiceInterfacePort_address), this);
                _stub.setPortName(getCustomTargetingServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201101", "CustomTargetingService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201101", "CustomTargetingServiceInterfacePort"));
        }
