...
public class CreativeTemplateServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.v201311.CreativeTemplateService {
    ...
    public com.google.api.ads.dfp.v201311.CreativeTemplateServiceInterface getCreativeTemplateServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.v201311.CreativeTemplateServiceInterface getCreativeTemplateServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.v201311.CreativeTemplateServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201311.CreativeTemplateServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.v201311.CreativeTemplateServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.v201311.CreativeTemplateServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201311.CreativeTemplateServiceSoapBindingStub(new java.net.URL(CreativeTemplateServiceInterfacePort_address), this);
                _stub.setPortName(getCreativeTemplateServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201311", "CreativeTemplateService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201311", "CreativeTemplateServiceInterfacePort"));
        }
