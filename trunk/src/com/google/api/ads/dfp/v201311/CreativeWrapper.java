...
public class CreativeWrapper  implements java.io.Serializable {
    ...
    private com.google.api.ads.dfp.v201311.CreativeWrapperHtmlSnippet header;

    /* The footer HTML snippet that this creative wrapper delivers. */
    private com.google.api.ads.dfp.v201311.CreativeWrapperHtmlSnippet footer;

    /* If there are multiple wrappers for a creative, then
     *                 {@code ordering} defines the order in which the HTML
     * snippets are rendered. */
    private com.google.api.ads.dfp.v201311.CreativeWrapperOrdering ordering;

    /* The status of the {@code CreativeWrapper}. This attribute is
     * readonly. */
    private com.google.api.ads.dfp.v201311.CreativeWrapperStatus status;
    ...
    public CreativeWrapper(
           ...
           com.google.api.ads.dfp.v201311.CreativeWrapperHtmlSnippet header,
           com.google.api.ads.dfp.v201311.CreativeWrapperHtmlSnippet footer,
           com.google.api.ads.dfp.v201311.CreativeWrapperOrdering ordering,
           com.google.api.ads.dfp.v201311.CreativeWrapperStatus status) {
           this.id = id;
     ...
     */
    public com.google.api.ads.dfp.v201311.CreativeWrapperHtmlSnippet getHeader() {
        return header;
    }
     ...
     */
    public void setHeader(com.google.api.ads.dfp.v201311.CreativeWrapperHtmlSnippet header) {
        this.header = header;
    }
     ...
     */
    public com.google.api.ads.dfp.v201311.CreativeWrapperHtmlSnippet getFooter() {
        return footer;
    }
     ...
     */
    public void setFooter(com.google.api.ads.dfp.v201311.CreativeWrapperHtmlSnippet footer) {
        this.footer = footer;
    }
     ...
     * snippets are rendered.
     */
    public com.google.api.ads.dfp.v201311.CreativeWrapperOrdering getOrdering() {
        return ordering;
    }
     ...
     * snippets are rendered.
     */
    public void setOrdering(com.google.api.ads.dfp.v201311.CreativeWrapperOrdering ordering) {
        this.ordering = ordering;
    }
     ...
     * readonly.
     */
    public com.google.api.ads.dfp.v201311.CreativeWrapperStatus getStatus() {
        return status;
    }
     ...
     * readonly.
     */
    public void setStatus(com.google.api.ads.dfp.v201311.CreativeWrapperStatus status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201311", "CreativeWrapper"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201311", "labelId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201311", "header"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201311", "CreativeWrapperHtmlSnippet"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("footer");
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201311", "footer"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201311", "CreativeWrapperHtmlSnippet"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201311", "ordering"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201311", "CreativeWrapperOrdering"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201311", "CreativeWrapperStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
