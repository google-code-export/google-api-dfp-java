...
public class ReconciliationImportErrorReason implements java.io.Serializable {
    ...
    public static final java.lang.String _ILLEGAL_CONVERTION = "ILLEGAL_CONVERTION";
    ...
    public static final ReconciliationImportErrorReason ILLEGAL_CONVERTION = new ReconciliationImportErrorReason(_ILLEGAL_CONVERTION);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201311", "ReconciliationImportError.Reason"));
    }
    /**
