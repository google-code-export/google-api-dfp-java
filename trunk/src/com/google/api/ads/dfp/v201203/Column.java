...
public class Column implements java.io.Serializable {
    ...
    public static final java.lang.String _AD_EXCHANGE_REVENUE = "AD_EXCHANGE_REVENUE";
    public static final java.lang.String _AD_EXCHANGE_AVERAGE_ECPM = "AD_EXCHANGE_AVERAGE_ECPM";
    ...
    public static final java.lang.String _POST_IMPRESSION_ACTIVITIES = "POST_IMPRESSION_ACTIVITIES";
    public static final java.lang.String _ACTIVITIES_PER_THOUSAND_IMPRESSIONS = "ACTIVITIES_PER_THOUSAND_IMPRESSIONS";
    public static final java.lang.String _POST_CLICK_ACTIVITIES = "POST_CLICK_ACTIVITIES";
    public static final java.lang.String _ACTIVITIES_PER_CLICK = "ACTIVITIES_PER_CLICK";
    public static final java.lang.String _POST_IMPRESSION_REVENUE = "POST_IMPRESSION_REVENUE";
    public static final java.lang.String _POST_CLICK_REVENUE = "POST_CLICK_REVENUE";
    public static final java.lang.String _TOTAL_ACTIVITIES = "TOTAL_ACTIVITIES";
    public static final java.lang.String _TOTAL_ACTIVITY_REVENUE = "TOTAL_ACTIVITY_REVENUE";
    ...
    public static final Column AD_EXCHANGE_REVENUE = new Column(_AD_EXCHANGE_REVENUE);
    public static final Column AD_EXCHANGE_AVERAGE_ECPM = new Column(_AD_EXCHANGE_AVERAGE_ECPM);
    ...
    public static final Column POST_IMPRESSION_ACTIVITIES = new Column(_POST_IMPRESSION_ACTIVITIES);
    public static final Column ACTIVITIES_PER_THOUSAND_IMPRESSIONS = new Column(_ACTIVITIES_PER_THOUSAND_IMPRESSIONS);
    public static final Column POST_CLICK_ACTIVITIES = new Column(_POST_CLICK_ACTIVITIES);
    public static final Column ACTIVITIES_PER_CLICK = new Column(_ACTIVITIES_PER_CLICK);
    public static final Column POST_IMPRESSION_REVENUE = new Column(_POST_IMPRESSION_REVENUE);
    public static final Column POST_CLICK_REVENUE = new Column(_POST_CLICK_REVENUE);
    public static final Column TOTAL_ACTIVITIES = new Column(_TOTAL_ACTIVITIES);
    public static final Column TOTAL_ACTIVITY_REVENUE = new Column(_TOTAL_ACTIVITY_REVENUE);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201203", "Column"));
    }
    /**
