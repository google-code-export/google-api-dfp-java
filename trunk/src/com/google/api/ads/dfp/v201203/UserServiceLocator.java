...
public class UserServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.v201203.UserService {
    ...
    private java.lang.String UserServiceInterfacePort_address = "https://www.google.com/apis/ads/publisher/v201203/UserService";
    ...
    public com.google.api.ads.dfp.v201203.UserServiceInterface getUserServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.v201203.UserServiceInterface getUserServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.v201203.UserServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201203.UserServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.v201203.UserServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.v201203.UserServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201203.UserServiceSoapBindingStub(new java.net.URL(UserServiceInterfacePort_address), this);
                _stub.setPortName(getUserServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201203", "UserService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201203", "UserServiceInterfacePort"));
        }
