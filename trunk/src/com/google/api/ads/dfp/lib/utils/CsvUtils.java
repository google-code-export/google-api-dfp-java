...
public final class CsvUtils {
  /**
   * {@code CsvUtils} is meant to be used statically.
   */
  private CsvUtils() {}
  ...
  public static Map<String, String> getCsvDataMap(String fileName,
    ...
    if (key < 0) {
      throw new IllegalArgumentException("Key index " + key + " must be greater than 0.");
    }

    if (value < 0) {
      throw new IllegalArgumentException("Value index " + value + " must be greater than 0.");
    }
          ...
          public void processLine(String[] header, String[] line, int lineNumber) {
            if (key >= line.length) {
              throw new IllegalArgumentException(
                  "The CSV file does not contain the key column indexed by "
                  + key + " on line " + lineNumber + ".");
            }

            if (value >= line.length) {
              throw new IllegalArgumentException(
                  "The CSV file does not contain the value column indexed by "
    ...
    new CsvReader(fileName, headerPresent).processReader(
        new CsvReader.CsvWorker() {
          public void processLine(String[] header, String[] line, int lineNumber) {
            if (line.length < 2) {
              throw new IllegalArgumentException(
                  "The number of columns must be greater than 2 on line " + lineNumber + ".");
            }
  ...
  public static List<String> getCsvDataByColumn(String fileName, final int column,
      boolean headerPresent) throws IOException {
    if (column < 0) {
      throw new IllegalArgumentException("Column index " + column + " must be greater than 0.");
    }
          ...
          public void processLine(String[] headers, String[] line, int lineNumber) {
            if (column > line.length - 1) {
              throw new IllegalArgumentException("Column index "
                  + column + " not present in CSV on line " + lineNumber);
            }
