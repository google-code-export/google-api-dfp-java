...
public class OrderActionErrorReason implements java.io.Serializable {
    ...
    public static final OrderActionErrorReason UNKNOWN = new OrderActionErrorReason(_UNKNOWN);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201204", "OrderActionError.Reason"));
    }
    /**
