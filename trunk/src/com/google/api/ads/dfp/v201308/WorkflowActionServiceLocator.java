...
public class WorkflowActionServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.v201308.WorkflowActionService {
    ...
    public com.google.api.ads.dfp.v201308.WorkflowActionServiceInterface getWorkflowActionServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.v201308.WorkflowActionServiceInterface getWorkflowActionServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.v201308.WorkflowActionServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201308.WorkflowActionServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.v201308.WorkflowActionServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.v201308.WorkflowActionServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201308.WorkflowActionServiceSoapBindingStub(new java.net.URL(WorkflowActionServiceInterfacePort_address), this);
                _stub.setPortName(getWorkflowActionServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
