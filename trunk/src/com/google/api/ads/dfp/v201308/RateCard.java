...
public class RateCard  implements java.io.Serializable {
    ...
    private com.google.api.ads.dfp.v201308.RateCardStatus status;
    ...
    public RateCard(
           ...
           com.google.api.ads.dfp.v201308.RateCardStatus status,
           long[] appliedTeamIds) {
           this.id = id;
           this.name = name;
           this.status = status;
     ...
     *                 created in the {@link RateCardStatus#INACTIVE} state.
     */
    public com.google.api.ads.dfp.v201308.RateCardStatus getStatus() {
        return status;
    }
     ...
     *                 created in the {@link RateCardStatus#INACTIVE} state.
     */
    public void setStatus(com.google.api.ads.dfp.v201308.RateCardStatus status) {
        this.status = status;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201308", "RateCard"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201308", "RateCardStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
