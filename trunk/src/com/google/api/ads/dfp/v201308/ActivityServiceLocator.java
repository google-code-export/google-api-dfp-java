...
public class ActivityServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.v201308.ActivityService {
    ...
    public com.google.api.ads.dfp.v201308.ActivityServiceInterface getActivityServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.v201308.ActivityServiceInterface getActivityServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.v201308.ActivityServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201308.ActivityServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.v201308.ActivityServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.v201308.ActivityServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201308.ActivityServiceSoapBindingStub(new java.net.URL(ActivityServiceInterfacePort_address), this);
                _stub.setPortName(getActivityServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201308", "ActivityService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201308", "ActivityServiceInterfacePort"));
        }
