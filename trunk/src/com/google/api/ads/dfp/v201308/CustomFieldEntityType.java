...
public class CustomFieldEntityType implements java.io.Serializable {
    ...
    public static final CustomFieldEntityType PRODUCT_TEMPLATE = new CustomFieldEntityType(_PRODUCT_TEMPLATE);
    public static final CustomFieldEntityType PRODUCT = new CustomFieldEntityType(_PRODUCT);
    public static final CustomFieldEntityType PROPOSAL = new CustomFieldEntityType(_PROPOSAL);
    public static final CustomFieldEntityType PROPOSAL_LINE_ITEM = new CustomFieldEntityType(_PROPOSAL_LINE_ITEM);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201308", "CustomFieldEntityType"));
    }
    /**
