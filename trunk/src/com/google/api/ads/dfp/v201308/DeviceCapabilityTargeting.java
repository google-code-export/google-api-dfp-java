...
public class DeviceCapabilityTargeting  implements java.io.Serializable {
    ...
    private com.google.api.ads.dfp.v201308.Technology[] targetedDeviceCapabilities;

    /* Device capabilities that are being excluded by the {@link LineItem}. */
    private com.google.api.ads.dfp.v201308.Technology[] excludedDeviceCapabilities;

    public DeviceCapabilityTargeting() {
    }

    public DeviceCapabilityTargeting(
           com.google.api.ads.dfp.v201308.Technology[] targetedDeviceCapabilities,
           com.google.api.ads.dfp.v201308.Technology[] excludedDeviceCapabilities) {
     ...
     */
    public com.google.api.ads.dfp.v201308.Technology[] getTargetedDeviceCapabilities() {
     ...
     */
    public void setTargetedDeviceCapabilities(com.google.api.ads.dfp.v201308.Technology[] targetedDeviceCapabilities) {
        this.targetedDeviceCapabilities = targetedDeviceCapabilities;
    }

    public com.google.api.ads.dfp.v201308.Technology getTargetedDeviceCapabilities(int i) {
        return this.targetedDeviceCapabilities[i];
    }

    public void setTargetedDeviceCapabilities(int i, com.google.api.ads.dfp.v201308.Technology _value) {
     ...
     */
    public com.google.api.ads.dfp.v201308.Technology[] getExcludedDeviceCapabilities() {
     ...
     */
    public void setExcludedDeviceCapabilities(com.google.api.ads.dfp.v201308.Technology[] excludedDeviceCapabilities) {
        this.excludedDeviceCapabilities = excludedDeviceCapabilities;
    }

    public com.google.api.ads.dfp.v201308.Technology getExcludedDeviceCapabilities(int i) {
        return this.excludedDeviceCapabilities[i];
    }

    public void setExcludedDeviceCapabilities(int i, com.google.api.ads.dfp.v201308.Technology _value) {
