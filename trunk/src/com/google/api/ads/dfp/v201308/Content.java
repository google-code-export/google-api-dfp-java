...
public class Content  implements java.io.Serializable {
    ...
    private com.google.api.ads.dfp.v201308.ContentStatus status;

    /* Whether the content status was defined by the user, or by the
     * source CMS
     *                 from which the content was ingested. This attribute
     * is read-only. */
    private com.google.api.ads.dfp.v201308.ContentStatusDefinedBy statusDefinedBy;
     ...
     * from. */
    private com.google.api.ads.dfp.v201308.CmsContent[] cmsSources;
    ...
    public Content(
           ...
           com.google.api.ads.dfp.v201308.ContentStatus status,
           com.google.api.ads.dfp.v201308.ContentStatusDefinedBy statusDefinedBy,
           long[] userDefinedCustomTargetingValueIds,
           long[] mappingRuleDefinedCustomTargetingValueIds,
           com.google.api.ads.dfp.v201308.CmsContent[] cmsSources) {
           this.id = id;
           this.name = name;
           this.status = status;
     ...
     */
    public com.google.api.ads.dfp.v201308.ContentStatus getStatus() {
        return status;
    }
     ...
     */
    public void setStatus(com.google.api.ads.dfp.v201308.ContentStatus status) {
        this.status = status;
    }
     ...
     * is read-only.
     */
    public com.google.api.ads.dfp.v201308.ContentStatusDefinedBy getStatusDefinedBy() {
     ...
     * is read-only.
     */
    public void setStatusDefinedBy(com.google.api.ads.dfp.v201308.ContentStatusDefinedBy statusDefinedBy) {
        this.statusDefinedBy = statusDefinedBy;
    }
     ...
     * from.
     */
    public com.google.api.ads.dfp.v201308.CmsContent[] getCmsSources() {
        return cmsSources;
    }
     ...
     * from.
     */
    public void setCmsSources(com.google.api.ads.dfp.v201308.CmsContent[] cmsSources) {
        this.cmsSources = cmsSources;
    }

    public com.google.api.ads.dfp.v201308.CmsContent getCmsSources(int i) {
        return this.cmsSources[i];
    }

    public void setCmsSources(int i, com.google.api.ads.dfp.v201308.CmsContent _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201308", "Content"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201308", "ContentStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("statusDefinedBy");
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201308", "statusDefinedBy"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201308", "ContentStatusDefinedBy"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("userDefinedCustomTargetingValueIds");
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201308", "userDefinedCustomTargetingValueIds"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201308", "mappingRuleDefinedCustomTargetingValueIds"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "long"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201308", "cmsSources"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201308", "CmsContent"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
