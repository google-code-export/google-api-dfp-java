...
public class ReconciliationReportRowServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.v201306.ReconciliationReportRowService {
    ...
    public com.google.api.ads.dfp.v201306.ReconciliationReportRowServiceInterface getReconciliationReportRowServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.v201306.ReconciliationReportRowServiceInterface getReconciliationReportRowServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.v201306.ReconciliationReportRowServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201306.ReconciliationReportRowServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.v201306.ReconciliationReportRowServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.v201306.ReconciliationReportRowServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201306.ReconciliationReportRowServiceSoapBindingStub(new java.net.URL(ReconciliationReportRowServiceInterfacePort_address), this);
                _stub.setPortName(getReconciliationReportRowServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201306", "ReconciliationReportRowService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201306", "ReconciliationReportRowServiceInterfacePort"));
        }
