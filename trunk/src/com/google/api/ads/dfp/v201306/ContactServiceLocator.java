...
public class ContactServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.v201306.ContactService {
    ...
    public com.google.api.ads.dfp.v201306.ContactServiceInterface getContactServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.v201306.ContactServiceInterface getContactServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.v201306.ContactServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201306.ContactServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.v201306.ContactServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.v201306.ContactServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201306.ContactServiceSoapBindingStub(new java.net.URL(ContactServiceInterfacePort_address), this);
                _stub.setPortName(getContactServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201306", "ContactService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201306", "ContactServiceInterfacePort"));
        }
