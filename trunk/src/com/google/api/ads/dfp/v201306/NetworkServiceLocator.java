...
public class NetworkServiceLocator extends org.apache.axis.client.Service implements com.google.api.ads.dfp.v201306.NetworkService {
    ...
    public com.google.api.ads.dfp.v201306.NetworkServiceInterface getNetworkServiceInterfacePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.google.api.ads.dfp.v201306.NetworkServiceInterface getNetworkServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.google.api.ads.dfp.v201306.NetworkServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201306.NetworkServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.google.api.ads.dfp.v201306.NetworkServiceInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                com.google.api.ads.dfp.v201306.NetworkServiceSoapBindingStub _stub = new com.google.api.ads.dfp.v201306.NetworkServiceSoapBindingStub(new java.net.URL(NetworkServiceInterfacePort_address), this);
                _stub.setPortName(getNetworkServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201306", "NetworkService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201306", "NetworkServiceInterfacePort"));
        }
