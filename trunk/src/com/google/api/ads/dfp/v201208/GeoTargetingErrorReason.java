...
public class GeoTargetingErrorReason implements java.io.Serializable {
    ...
    public static final GeoTargetingErrorReason UNKNOWN = new GeoTargetingErrorReason(_UNKNOWN);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201208", "GeoTargetingError.Reason"));
    }
    /**
