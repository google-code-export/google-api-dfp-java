...
public class ContentServiceSoapBindingStub extends org.apache.axis.client.Stub implements com.google.api.ads.dfp.v201211.ContentServiceInterface {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(com.google.api.ads.dfp.v201211.ContentPage.class);
    ...
    public ContentServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.v201211.Content.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.v201211.ContentPage.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.v201211.ContentPartnerError.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.v201211.ContentPartnerErrorReason.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.v201211.ContentStatus.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
            ...
            cachedSerQNames.add(qName);
            cls = com.google.api.ads.dfp.v201211.ContentStatusDefinedBy.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(enumsf);
            cachedDeserFactories.add(enumdf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {statement});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (com.google.api.ads.dfp.v201211.ContentPage) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.google.api.ads.dfp.v201211.ContentPage) org.apache.axis.utils.JavaUtils.convert(_resp, com.google.api.ads.dfp.v201211.ContentPage.class);
            }
        }
